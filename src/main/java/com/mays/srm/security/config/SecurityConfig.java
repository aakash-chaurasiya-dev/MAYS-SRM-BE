...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                // Disable CSRF (Cross-Site Request Forgery) because we are building a REST API
                                // (JWTs are safe from this)
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.GET, "/api/users/vendor/**")
                                                .hasAnyRole("MANAGER", "ADMIN", "EXECUTIVE", "VENDOR")
                                ...
                                // Add RateLimitFilter BEFORE JwtAuthFilter to block bots early
                                .addFilterBefore(rateLimitFilter, UsernamePasswordAuthenticationFilter.class)

                                // Add our custom Security Guard (JwtFilter) BEFORE the standard
        ...
        /**
         * RULE BOOK 2: Setup the component that fetches user details and compares the
         * hashed password.
         */
        @Bean
        ...
        /**
         * RULE BOOK 3: Setup the Authentication Manager (The Boss that we call in
         * AuthController to attempt a login)
         */
        @Bean
        ...
        /**
         * RULE BOOK 4: Setup the Password Encoder (Tells Spring we are using BCrypt
